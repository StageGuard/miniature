...
use x86_64::{instructions::tables::load_tss, structures::{gdt::{Descriptor, GlobalDescriptorTable}, tss::TaskStateSegment}, VirtAddr};
...
pub unsafe fn init_gdt(gdt_virt_addr: u64) {
